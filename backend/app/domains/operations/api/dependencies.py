...
require_installations_read = require_permission(Permission.INSTALLATIONS_READ)
require_installations_write = require_permission(Permission.INSTALLATIONS_WRITE)
